...
import { CitasIssemym2026Service } from '../../../../service/citas-issemym2026.service';

@Component({
  selector: 'app-issemym2026',
  imports: [
    NgxDatatableModule, 
    CommonModule, 
    RouterModule, 
  ...
  templateUrl: './issemym2026.component.html',
  styleUrl: './issemym2026.component.scss'
})
export class Issemym2026Component {
  ...
  public _citasService = inject(CitasIssemym2026Service);

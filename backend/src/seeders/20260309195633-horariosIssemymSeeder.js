...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    const csvFilePath = path.resolve(__dirname, '../database/catalogos/horarioIssemym.csv');

    // Vaciar tabla antes de insertar
    await queryInterface.bulkDelete('horarios_issemym', null, {});
      ...
      fs.createReadStream(csvFilePath)
        ...
        .on('end', async () => {
          ...
          if (horarios.length > 0) {
            await queryInterface.bulkInsert('horarios_issemym', horarios, {});
          }

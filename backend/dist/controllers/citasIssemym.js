...
const getHorariosDisponibles = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const horariosDisponibles = yield horarios_issemym_1.default.findAll({
            order: [["id", "ASC"]],
        });
...
const savecita = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const { body } = req;
        const limite = 1;
        const citaExistente = yield citas_issemym_1.default.findOne({
            where: { rfc: body.rfc }
        });
        if (citaExistente) {
        ...
        const cantidadCitas = yield citas_issemym_1.default.count({
            where: {
        ...
        const cita = yield citas_issemym_1.default.create({
            horario_id: body.horario_id,
            sede_id: body.sede_id,
            rfc: body.rfc,
            fecha_cita: body.fecha_cita,
        ...
        const horarios = yield horarios_issemym_1.default.findOne({
...
function generarPDFBuffer(data) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            doc.moveDown();
            doc.fontSize(11).text("De acuerdo al reglamento para la afiliación de Derechohabientes del Instituto de Seguridad Social del Estado de México y Municipios, que indica la vigencia de la credencialización. Artpiculo 7.- Los derechohabientes tienen la obligación de renovar la identificación institucional; para el caso de menores de edad, su renovación será cada cinco años hasta cumplir 18 años, en el caso de mayores de edad, será cada diez años. En caso de presentarse alguna duda, error o requerir asistencia relacionada con el acceso, comunícate a las extensiones 5506 y 5516 del Departamento de Desarrollo y Actualización Tecnológica.", { align: "justify" });
            doc.moveDown();
            doc.fontSize(11).text("Para acceder a este beneficio, es indispensable presentar en el día y hora asignados.", { align: "justify" });
            doc.moveDown();
            doc.fontSize(11).text("Costos", { align: "justify" });
            doc.moveDown();
...
const generarPdfAcuse = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const citaHora = ((_b = cita === null || cita === void 0 ? void 0 : cita.HorarioIssemym) === null || _b === void 0 ? void 0 : _b.horario_inicio) + '-' + ((_c = cita === null || cita === void 0 ? void 0 : cita.HorarioIssemym) === null || _c === void 0 ? void 0 : _c.horario_fin);

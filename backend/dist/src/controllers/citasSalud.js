...
const getCita = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const datosGenerales = yield dp_fum_datos_generales_1.dp_fum_datos_generales.findOne({
            where: { f_rfc: id },
            attributes: ["f_curp", "f_fecha_nacimiento"]
        });
        const sexo = sexoDesdeCurp(datosGenerales === null || datosGenerales === void 0 ? void 0 : datosGenerales.f_curp);
        const edad = calcularEdad(datosGenerales === null || datosGenerales === void 0 ? void 0 : datosGenerales.f_fecha_nacimiento);
...
function generarPDFBufferSalud(data) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            doc.moveDown();
            doc.font('Helvetica').fontSize(11).text('La Delegación SUTEyM-Poder Legislativo invita a la "Jornada de Salud y Prevención SUTEyM 2026", con el propósito de fortalecer las acciones preventivas y contribuir a la protección y al cuidado de la salud de las personas servidoras públicas del Poder Legislativo.', { align: "justify" });
            doc.moveDown();
